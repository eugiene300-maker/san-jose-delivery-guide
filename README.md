...
Live: https://eugiene300-maker.github.io/san-jose-delivery-guide
...
Primary address: https://eugiene300-maker.github.io/san-jose-delivery-guide/ (GitHub Pages, published by `.github/workflows/pages.yml` on every push to `main` and after each scheduled refresh). Canonical URLs, the sitemap and llms.txt point to this address; it is set in `data/config.json`.
